...
function loadContentData() {  
  ...
  const loadFromFirebase = GL_Settings.loadFromFirebase || false;
  if (loadFromFirebase) {
    contentData = window.gv && window.gv.sts && Array.isArray(window.gv.sts.rows_table_content) ? window.gv.sts.rows_table_content : contentData;
  } else {
